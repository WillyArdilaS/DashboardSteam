...
const MostPlayedDiscountGraph = () => {
    const [games, setGames] = useState([]);

    useEffect(() => {
        setGames([]);
      
        axios.get(`http://127.0.0.1:5000/juegos/mas-jugados-con-descuento`)
        .then((res) => {
    ...
    const options = {
        plugins: {
            title: {
                display: true,
                text: 'JUEGOS MÁS JUGADOS CON DESCUENTO',
            },
        },
        scales: {
            y: {
...
export default MostPlayedDiscountGraph;
