...
app = Flask(__name__)
CORS(app, resources={r"/juegos/*": {"origins": "*", "allow_headers": "Content-Type"}})

db_config = {
    "user": "root",
    "password": "admin",
    "host": "localhost",
    "database": "proyectotendencias",
    "port": 3306
}
...
@app.route('/juegos/mas-jugados-por-fecha', methods=['POST'])  # Corrige la ruta
